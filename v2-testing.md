...
I have built in media server importing to this version and i have tested on Jellyfin, Emby and Plex. All services allow you to connect to your server and then choose a libary to import. When importing it will add to whatever is your library already and not overwrite, unless you have added the same film manually.  PLEASE NOTE: This functionality has only been tested on my setup, so if you have any issues i would need to know your configuration to see if there would be a fix.
